...
<head>
	...
	<!-- Favicon icon -->
	<link rel="icon" type="image/png" sizes="16x16" href="assets/apps/icon/icon.png">
</head>
<style>
...
<body>
	<main class="bsod container">
		<div class="coding-time">
			<!-- <img src="assets/apps/icon/icon.png" alt="Apps" style="width: 205px;"> -->
		</div>
		...
		<nav class="nav">
			<a onclick="history.back()" class="link">Homepage</a< /a>
		</nav>
	</main>
</body>
